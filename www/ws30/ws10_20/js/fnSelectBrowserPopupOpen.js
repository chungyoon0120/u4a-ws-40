...
(function(window, $, oAPP) {
    ...
    oAPP.fn.fnSelectBrowserPopupOpen = async function() {
        ...
        parent.DEV_SOURCE_FINDER.setRunScriptPath(oDialog);
        ...
        oPanelTemplate.bindProperty("visible", {
            parts: [
                { path: "NAME" }
        ...
        let oCheckBox1 = new sap.m.CheckBox({
            ...
            select: function(oEvent){
                ...
                let oCtx = oUI.getBindingContext();
                if(!oCtx){
                    return;
                }
                ...
                //     oModel.setProperty("DEV_MODE", !this.getSelected(), oCtx);                    
                // }
        ...
        oCheckBox1.bindProperty("visible", {
            parts: [
                { path: "NAME" }
            ...
            formatter: function(NAME){
                ...
                // 개발 모드 브라우저 항목일 경우는 앱 모드 체크박스를 숨긴다.
                if(NAME === "DEV_BROWSER"){
                    return false;
                }
        ...
        let oCheckBox2 = new sap.m.CheckBox({
            ...
            select: function(oEvent){
                ...
                if(this.getSelected() === true){
                    oModel.setProperty("APP_MODE", !this.getSelected(), oCtx);                    
                }
