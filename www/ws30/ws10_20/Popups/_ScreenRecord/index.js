...
//====================================================// 
  onInitData: ()=>{
    ...
    let oSIGN = document.getElementById("signature-pad");
    ...
    if(process.env.LOCALAPPDATA !== ""){
      oAPP.saveDirectory = oAPP.path.join(process.env.LOCALAPPDATA, sUserDataPath, "video");
      
    }else{
      oAPP.saveDirectory = oAPP.path.join(process.env.APPDATA, sUserDataPath, "video");
