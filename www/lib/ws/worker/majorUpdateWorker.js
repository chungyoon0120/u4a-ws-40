...
function _majorVersionDownPowerShell(oPARAM){
    ...
    return new Promise(function(resolve){
        ...
        // }
        /**
         * MAJOR PATCH 실행 파라미터 구성
         */
        let aParams = [
            `--PRCCD=UPGRADE`,              // 프로세스 코드 (UPGRADE)
            `--ACTCD=ws_update_file_get`,   // 액션 코드 (ws_update_file_get)
            ...
            `--DOWN_PATH=${oPARAM.DOWN_PATH}`,   // [폴더] 로컬 다운로드 경로
        ...
        ps.stdout.on("data", (data) => {
            ...
            let sLog = `[Node Executer] Major 업데이트 파일 다운로드 중..: ${data.toString()}`;
