...
async function _chk_MultiScr(REMOTE) {
    return new Promise(async (RES, REJ) => {        
        ...
        const sUrlPath = PATH.join(__dirname, "ScrList.html");
...
exports.start = async function (REMOTE, P_THEME = "sap_horizon_dark") {    
    ...
    const sPopupName = "VIDEOREC";
    const sDispName = "VIDEOSCREEN";
    ...
    const sUrlPath = PATH.join(__dirname, "recoding.html");
